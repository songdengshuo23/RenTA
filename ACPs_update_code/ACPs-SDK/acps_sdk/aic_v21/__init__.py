...
基于 ACPs-spec-AIC-v02.01 规范实现。

AIC 结构（10级，以 '.' 分隔）：
    1-4: OID 前缀 (1.2.156.3088)
    5:   版本号 (Base36, 1位)
    6:   ARSP 注册服务商序号 (Base36, 1-6位)
    7:   Vendor 供应商序号 (Base36, 1-6位)
    8:   Ontology SN 本体序列号 (Base36, 1-9位)
    9:   Instance SN 实例序列号 (Base36, 1-9位, 全0表示本体AIC)
