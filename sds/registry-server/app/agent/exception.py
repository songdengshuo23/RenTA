...
class AgentError:
    ...
    REMOTE_CERT_SYNC_FAILED = "remote_cert_sync_failed"
    SUPERVISOR_REVIEW_NOT_FOUND = "supervisor_review_not_found"
    AGENT_PASSPORT_NOT_FOUND = "agent_passport_not_found"
...
class AtrErrorCode(IntEnum):
    ...
    AGENT_PASSPORT_NOT_FOUND = 40413
